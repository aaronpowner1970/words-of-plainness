...
scripture:
  ...
  url: "ot/jer/29?id=p13#p13"

readingTime: 25
sectionCount: 16

audio:
  narration: "chapter-05-narration.mp3"
  overview: "chapter-05-overview.mp3"
  testimony:
    ...
    alternates:
      - file: "05.2_Souls_Sincere_Desire_Contemporary_Christian.mp3"
        label: "Contemporary Christian Worship — Anthemic and Congregational"
        duration: "4:42"
      - file: "05.3_Souls_Sincere_Desire_Cinematic_Inspirational.mp3"
        label: "Cinematic Orchestral — Piano-Led with Full Orchestra Build"
        duration: "5:58"
      - file: "05.4_Souls_Sincere_Desire_Celtic_Worship.mp3"
        label: "Celtic Worship — Harp, Pipes, and Thin Places Spirituality"
        duration: "6:54"
      - file: "05.5_Souls_Sincere_Desire_Americana_Folk.mp3"
        label: "Americana Folk — Fingerpicked Guitar and Front Porch Testimony"
        duration: "5:59"
      - file: "05.6_Souls_Sincere_Desire_Broadway_Ballad.mp3"
...
toc:
  - id: the-souls-sincere-desire
    title: "The Soul's Sincere Desire"
  - id: a-pattern-for-meaningful-prayer
    title: A Pattern for Meaningful Prayer
  - id: forms-and-postures-of-prayer
    title: Forms and Postures of Prayer
  - id: true-prayer-is-not-for-show
    title: True Prayer Is Not for Show
  - id: preparing-for-meaningful-prayer
    title: Preparing for Meaningful Prayer
  - id: prayer-in-urgent-moments
    title: Prayer in Urgent Moments
  - id: constant-prayer
    title: Constant Prayer
  - id: praying-for-others
    title: Praying for Others
  - id: when-prayers-seem-unanswered
    title: When Prayers Seem Unanswered
  - id: balancing-agency-and-divine-dependence
    title: Balancing Agency and Divine Dependence
  - id: humility-and-submission-before-god
    title: Humility and Submission Before God
  - id: grace-after-all-we-can-do
    title: Grace After All We Can Do
  - id: prayer-as-two-way-communication
    title: Prayer as Two-Way Communication
  - id: prayer-as-a-covenant-practice
    title: Prayer as a Covenant Practice
  - id: gods-unchanging-nature
...
{% sentence 53 %}Under urgent or stressful conditions, we can still pray effectively for help and guidance.{% endsentence %} {% sentence 54 %}These conditions might be dangerous situations, moments of confrontation with others, or even unexpected opportunities to do something good in the world.{% endsentence %} {% sentence 55 %}Under such conditions our thoughts should instantly turn to God in the very moment of dealing with the situation.{% endsentence %} {% sentence 56 %}The spirit is much faster than the flesh.{% endsentence %} {% sentence 57 %}If you carefully develop spirituality prior to an emergency, when you do cast your thoughts and feelings to God in the very moment of need, your mind makes an instant and profound connection with Him.{% endsentence %} {% sentence 58 %}In response, the spirit and power of God will instantly well up in your soul to inspire your thoughts, words, and actions to bring about the greatest good.{% endsentence %}

<h2 id="constant-prayer">{% sentence 59 %}Constant Prayer{% endsentence %}</h2>
...
{% sentence 204 %}The ninth article of faith of The Church of Jesus Christ of Latter-day Saints states, "We believe all that God has revealed, all that He does now reveal, and we believe that He will yet reveal many great and important things pertaining to the Kingdom of God."{% endsentence %} {% sentence 205 %}Prayer leads to personal revelation: when we pray right, when we pray always, when we pray for the right reasons, and when we listen to God's answers.{% endsentence %}
